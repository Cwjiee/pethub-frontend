      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <a href="https://www.facebook.com/profile.php?id=100013712179463" className="hover:underline ">Facebook</a>
                </li>
                <li>
                  <a href="https://www.instagram.com/tharshen_sb/" className="hover:underline">Instgram</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/profile.php?id=100013712179463" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://www.instagram.com/tharshen_sb/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
