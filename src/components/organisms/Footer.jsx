          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                ...
                <li className="mb-4">
                  <Link href="https://tailwindcss.com/" className="hover:underline">Veterinary</Link>
                </li>
                <li className="mb-4">
                  <Link href="https://flowbite.com" className="hover:underline">Pet Boarder</Link>
                </li>
                <li className="mb-4">
                  <Link href="https://flowbite.com" className="hover:underline">Forums</Link>
                </li>
              </ul>
            </div>
            <div>
