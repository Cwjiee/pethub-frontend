      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <a href="https://www.facebook.com/profile.php?id=100019487506131" className="hover:underline ">Facebook</a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                ...
                <li>
                  <Link href="/terms_and_conditions" className="hover:underline">Terms &amp; Conditions</Link>
                </li>
                <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/profile.php?id=100019487506131" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
