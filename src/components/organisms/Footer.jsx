      ...
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="/healthcare-facility" className="flex items-center">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <Link href="/news" className="hover:underline">Pet News</Link>
                </li>
                <li className="mb-4">
                  <Link href="/pet-grooming" className="hover:underline">Grooming</Link>
                </li>
                <li className="mb-4">
                  <Link href="/healthcare-facility" className="hover:underline">Healthcare Facility</Link>
                </li>
                <li className="mb-4">
            ...
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <a target="_blank" href="https://www.facebook.com/profile.php?id=100019487506131" className="hover:underline ">Facebook</a>
                </li>
                <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/healthcare-facility" className="hover:underline">Pethub™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a target="_blank" href="https://www.facebook.com/profile.php?id=100019487506131" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
